...
export default function DueDiligenceSuite() {
    return (
        <section id="due-diligence" className="py-24 bg-white dark:bg-slate-900 min-h-screen flex flex-col justify-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {/* ── 1. Top Holders ── */}
                    <TiltCard>
                        <div className="h-full bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-xl shadow-purple-500/5 hover:shadow-2xl hover:border-purple-300/70 transition-shadow duration-300 group">
                    ...
                    {/* ── 5. Smart Money Flows ── */}
                    <TiltCard>
                        <div className="lg:col-span-1 h-full bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-xl shadow-purple-500/5 hover:shadow-2xl hover:border-purple-300/70 transition-shadow duration-300 group flex flex-col justify-between">
                            <div>
